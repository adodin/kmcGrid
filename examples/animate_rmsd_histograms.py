...
# Animate Populations
msd_ani = kmcGrid.animate.animate_msd_histogram(s0, s_traj, t_traj, target_times)
rmsd_ani = kmcGrid.animate.animate_rmsd_histogram(s0, s_traj, t_traj, target_times)
